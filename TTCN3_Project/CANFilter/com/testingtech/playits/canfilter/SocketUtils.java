...
public class SocketUtils {
  ...
  private CANFilterLog canFilterLog = new CANFilterLog(
      SocketUtils.class.getSimpleName());
  ...
  public InetSocketAddress createAddress(String... args) throws AddressInstantiationException {
    String host;
    int portNumber;
    if (args.length != 2) {
      ...
      throw new AddressInstantiationException("Wrong number of arguments");
    	...
    	else throw new AddressInstantiationException("Invalid port number");
    }
    return new InetSocketAddress(host, portNumber);
  }

  public ServerSocket createServerSocket(String... args) throws AddressInstantiationException {
